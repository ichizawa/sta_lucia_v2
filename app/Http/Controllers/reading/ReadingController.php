...
class ReadingController extends Controller
{
    ...
    {
        return view('reader.reading.index');
    }
    ...
    public function utilityReading(Request $request)
    {
    ...
    {
        return view('reader.bill.billing-index');
    }
    ...
    {
        return view('reader.period.billing-period');
    }
}
