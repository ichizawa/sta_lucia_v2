<div class="modal fade" id="editAwardNoticeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content h-100">
            <form action="{{ route('lease.notice.options', 'award') }}" method="POST" class="d-flex flex-column h-100">
                @csrf
...
<script>
    $(document).ready(function() {
        $('.approversModal').click(function() {
            ...
            var filePath = "{{ asset('storage/tenant_documents/') }}" + "/" + data.company_name + "/award_notice/" + pdfFileName;
