...
@section('content')
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3 title">Authorized Personnel</h3>
                <h6 class="op-7 mb-2">Personnel/s Overview</h6>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List of Authorized Personnels</h4>
                    </div>
                    <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $('#client-proposal-table').DataTable({
                pageLength: 10,
            });
        });
    </script>
