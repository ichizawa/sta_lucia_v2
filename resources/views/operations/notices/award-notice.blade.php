@extends('layouts')
@section('content')
    @include('operations.notices.notice-modals.edit-award-notice-modal')
    @include('operations.notices.notice-modals.view-award-files-modal')
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3 title">Award Notices</h3>
                <h6 class="op-7 mb-2">Notices Summary</h6>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
