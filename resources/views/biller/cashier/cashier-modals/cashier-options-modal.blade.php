...
<form id="cashierOptionsForm" method="POST">
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offCanvasCashier" aria-labelledby="offcanvasResponsiveLabel">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasResponsiveLabel">Creat Bill for Tenant</h5>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="date" class="form-control" name="dateFrom" placeholder="Enter Total Sales" required />
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label class="form-label">Date To</label>
              <input type="date" class="form-control" name="dateTo" placeholder="Enter Total Sales" required />
            </div>
          </div>
        </div>
      </div>
