    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-sta" data-bs-toggle="modal" data-bs-target="#utilityListModal">Back</button>
    ...
    $(document).on('click', '.contractUtil',function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data[0].proposal.utilities, function(key, value){
                    $('#contractTableUtility').append(`
                        <tr>
                            <td>${value.utility_name}</td>
                            <td>${value.utility_price}</td>
                            <td>
                                <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#utilityReadingModal">
                                    <i class="fa fa-pen"></i>
                                </button>
                            </td>
                        </tr>
