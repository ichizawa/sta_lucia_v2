            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-sta ms-auto">
                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $utility->utility_description }}</td>
                                    <td>{{ $utility->utility_price }}</td>
                                    <td>
                                        <!-- <a href="#" class="btn btn-sm btn-success ms-auto">
                                            <i class="fa fa-pen"></i>
                                        </a> -->
                                        <a href="#" class="btn btn-sm btn-danger ms-auto deleteBTN" data-id="{{$utility->id}}">
