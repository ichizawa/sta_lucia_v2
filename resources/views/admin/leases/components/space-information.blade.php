        ...
        <div class="card-body">
                    ...
                    <select name="spaceprop[]" class="form-control" id="spaceprop" required multiple>
                        @foreach ($space as $spaces)
                            <option value="{{$spaces->id}}" data-space-id="{{$spaces->id}}"
                                data-space-type="{{$spaces->store_type}}" data-space-floor-area="{{$spaces->space_area}}"
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input name="brent" type="text" class="form-control" id="brent" placeholder="Basic Rent" required>
                </div>
                <div class="form-group col-md-6">
            ...
            <input type="text" id="total_min_guaranteed_rent" name="total_guaranteed_rent" placeholder="Selected Rent" hidden/>
