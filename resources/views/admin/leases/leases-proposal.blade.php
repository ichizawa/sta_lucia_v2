                        ...
                        <table id="multi-filter-select" class="display table table-striped table-hover">
                            ...
                            <tbody id="proposals_table">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm btn-success showProposalContents" id="showProposalContents"
                                            data-show-proposal-id="{{ $proposals->id }}" data-bs-toggle="modal"
                                            data-bs-target="#leaseProposal"><i class="fa fa-eye"></i></a>
                                        ...
                                        <a class="btn btn-sm btn-danger deleteProposal"
                                            data-delete-proposal-id="{{ $proposals->id }}">
