...
<div id="utility-container" class="row utility-container">
    <!-- <div class="form-group col-md-6">
        <label for="utilities">Utility Name</label>
        <select class="form-control utility_names" id="utilities" name="utilityid[]">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="utility_fee" name="utilityfee[]" placeholder="Utility Fee"
            readonly />
    </div> -->
</div>