                                    ...
                                    <div class="card-body ">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="repcontact" type="text" class="form-control"
                                                    id="auth_contact" placeholder="Contact Number" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="email_address">Email Address</label>
                                                <input name="compemail" type="email" class="form-control"
                                                    id="email_address" placeholder="Email Address" readonly>
                                            </div>
                                        </div>
                                    </div>
        ...
        $(document).ready(function() {
            ...
            `);
                ...
                if (lastSelectedOption) {
                    $('#brent, #payment_disc').off('input').on('input', function() {
