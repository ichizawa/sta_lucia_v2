...
@section('content')
    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3 title">Amenities</h3>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-3 justify-content-center">
                                                    <a class="btn btn-sm btn-success editAmenitiesBTN"
                                                        data-amenity="{{ $amenity }}" data-bs-toggle="modal"
                                                        data-bs-target="#editAmenityModal"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-danger deleteBTN"
                                                        data-id="{{ $amenity->id }}"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
