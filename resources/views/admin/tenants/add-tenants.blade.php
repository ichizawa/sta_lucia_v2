                                    ...
                                    <div class="step1">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="tenant_type" class="form-control" id="tenantType" required>
                                ...
                                <div class="form-group col-md-12 main-step-1">
                                    <div class="step3">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="">First Name</label>
                                                <input type="text" class="form-control" id="rep_fname" name="repfname"
                                                    placeholder="First Name" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="">Last Name</label>
                                                <input type="text" class="form-control" id="rep_lname" name="replname"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="">Email</label>
                                                <input type="email" class="form-control" id="rep_email" name="repemail" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="">Telephone</label>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="">Mobile No.</label>
                                                <input type="tel" class="form-control" id="rep_mobile" name="repmobile" required>
                                            </div>
                                            <div class="form-group col-md-6">
                        ...
                        <div class="step5" style="display: none">
                            <div class="container">
                                ...
                                <div class="row d-flex justify-content-between mt-4">
                                    <div class="col-auto">
                                        <button type="button" class="btn btn-primary" id="back-button1">Back</button>
                                    </div>
                                    <div class="col-auto">
                                        <button type="button" class="btn " id="submit-button"
