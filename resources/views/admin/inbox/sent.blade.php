<div class="card">
    <div class="row align-items-start card-header brown-border-top">
        <!-- Inbox List -->
        <div class="col-md-5 border-end p-0 d-flex flex-column">
            ...
            <div class="overflow-auto" style="flex-grow: 1;" id="inbox-list">
        ...
        <div class="col-md-5 bg-white d-flex flex-column">
            <div class="p-3 border-bottom">
                <h6>To <span class="text-primary">Mark Zuckerberg</span> From Me</h6>
