...
<div class="page-inner">
    ...
    <form id="testrunonbroadcast" action="{{ route('space.submit.space') }}" method="POST"
                        ...
                        <div class="step1">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="search-mall-code" placeholder="Select Mall Code..." name="mallCode" required>
                                        <option value="" selected hidden disabled>Select Mall Code</option>
                                        @foreach ($mallcode as $mall)
                                            <option value="{{ $mall->mallnum }}" data-mallid="{{ $mall->id }}">{{ $mall->mallnum }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="search-bldg-number" placeholder="Select Building Number..." name="bldgnumber" required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="search-level-number" placeholder="Select Level Number..." name="levelNumber" required>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="selectgroup selectgroup-pills">
                                ...
                                <label class="selectgroup-item">
                                    <input type="checkbox" id="amenity_uid" name="amenity_ids[]" value="{{ $amenity->id }}" class="selectgroup-input" />
