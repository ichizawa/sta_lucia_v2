                ...
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <select id="level-mall-code" placeholder="Select Mall Code..." name="mallCode" class="form-control" required>
                    ...
                    <div class="col-md-12 mt-3">
                      ...
                      <select id="level-bldg-number" placeholder="Select Building Number..." name="buildingNum" class="form-control" required>
                ...
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <input type="file" id="image-upload" class="form-control" name="lvl_image" />
                    </div>
                    <div class="col-md-12 mt-3">
