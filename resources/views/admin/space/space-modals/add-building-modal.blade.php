<div class="modal fade" id="addBuildingModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form action="{{route('space.option.space', 'submitBuilding')}}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div id="mallListCodes" class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <select id="building-search-mall-code" placeholder="Select Mall Code..." name="mallCode" required>
                ...
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <input type="file" id="image-upload" class="form-control" name="bldg_image" />
                    </div>
