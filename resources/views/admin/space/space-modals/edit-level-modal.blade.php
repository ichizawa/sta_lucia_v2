<div class="modal fade" id="editLevelModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form id="modalEditLevel" action="{{route('space.option.space', 'submitLevel')}}" method="POST">
        @csrf
                ...
                <div id="mallListCodes" class="container-fluid">
                  <div class="row">
                      ...
                      <select id="mallcodeLevel" class="form-control" name="mallCode" disabled>
                        ...
                        @endforeach
                                ...
                                <div class="col-md-12">
                                  ...
                                  <select id="bldgnumber" class="form-control" placeholder="Select Building Number..."
                                    name="buildingNum" disabled>
                                    @foreach ($levelCode as $levels)
                          <option value="{{ $levels->lvlnumid }}">{{ $levels->bldgnum }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" id="lvlID" name="lvlNumID" hidden />
                    </div>
                    <div class="col-md-12">
                      <label>Total Area of Level</label>
                      <input type="text" class="form-control" id="total_area" name="total_area" placeholder="Total Area"
                        readonly />
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" id="total_leased" name="total_leased"
                ...
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <input type="file" id="image-upload2" class="form-control" name="lvl_image" />
                    </div>
...
<script>
  $(document).ready(function () {
    ...
    $('.editspecificLevels').click(function () {
      $.ajax({
        url: "{{route('space.edit.level', 'editLevel')}}",
        type: "GET",
        data: {
        ...
        success: function (data) {
          $.each(data, function (key, value) {
            ...
            $('#total_available').val(data.blding[0].mallcodes.total_available);
            $('#total_leased').val(data.blding[0].mallcodes.total_leased);
          });
        },
