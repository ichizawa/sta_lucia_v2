<div class="modal fade" id="addMallModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form action="{{route('space.option.space', 'submitMall')}}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div id="mallListCodes" class="container-fluid">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="mall_code" placeholder="Enter Mall Code" maxlength="3" required/>
                    </div>
                    <div class="col-md-6">
                      <label>Mall Name</label>
                      <input type="text" class="form-control" name="mall_name" placeholder="Enter Mall Name" required/>
                    </div>
                    <div class="col-md-12">
                      <label>Mall Address</label>
                      <input type="text" class="form-control" name="mall_address" placeholder="Enter Mall Address"
                        required />
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" name="total_area" placeholder="Total Area" readonly/>
                    </div>
                    <div class="col-md-12">
                      <label>Total Available Area</label>
                      <input type="text" class="form-control" name="total_available" placeholder="Total Available Area" readonly/>
                    </div>
                    <div class="col-md-12">
                      <label>Total Leased Area</label>
                      <input type="text" class="form-control" name="total_leased" placeholder="Total Leased Area" readonly/>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <input type="file" id="image-upload" class="form-control" name="mall_image" />
                    </div>
                    <div class="col-md-12 mt-3">
                      <img
                        ...
                        class="img-fluid card-img" id="show-image" alt="..." style="height: 55vh; object-fit: cover"/>
                    </div>
                  </div>
                </div>
              </div>
