                ...
                <div id="mallListCodes" class="container-fluid">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" id="mall_id" name="mall_id" hidden />
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                      ...
                      <input type="text" class="form-control" id="mall_address" name="mall_address"
                ...
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <input type="file" id="edit-image-upload" class="form-control" name="mall_image" />
                    </div>
                    <div class="col-md-12 mt-3">
                      <img
                        src=""
                        class="img-fluid card-img" id="edit-show-image" alt="..." style="height: 55vh; object-fit: cover" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          if(data.mallimage == null){
            $('#edit-show-image').attr('src', 'https://images.pexels.com/photos/28216688/pexels-photo-28216688/free-photo-of-autumn-camping.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');
          }else{
            $('#edit-show-image').attr('src', '{{ asset('storage/mall_images') }}' + '/' + data.mallimage);
          }
        },
