                            ...
                            <tbody>
                                @foreach ($notices as $notice)
                                    <tr>
                                        ...
                                        <td>{{ $notice->tenant_type }}</td>
                                        <td>{{ date("F j, Y", strtotime($notice->award_notice_created_at)) }}</td>
                                        <td>
                                            {!! 
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success approversModal" data-bs-toggle="modal" data-approvers="{{$notice}}" data-bs-target="#editAwardNoticeModal">
                                                <i class="fa fa-pen"></i>
                                            </a>
                                            <a class="btn btn-sm btn-warning filesModalTable" data-bs-toggle="modal" data-award-data="{{$notice}}" data-bs-target="#viewFilesModal">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
